...
public class FichaTecnicaREPORT extends javax.swing.JFrame {

    public FichaTecnicaREPORT() {

        initComponents();
        setTitle("Relatórios - Ficha Técnicas");
        setIconImage(Toolkit.getDefaultToolkit().getImage(FichaTecnicaREPORT.class.getResource("/imagens/real.png")));
    ...
    private void initComponents() {
        ...
        rbCusto = new javax.swing.JRadioButton();
        ...
        titulo.setText("Emitir Relatório sobre Fichas Técnicas");
        ...
        bgPesquisa.add(rbCusto);
        rbCusto.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        rbCusto.setText("Custo");
    ...
    private void jbEmitirCompletoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEmitirCompletoActionPerformed
        ...
        String src = "/relatorios/fichaTecnicaC.jasper";
        ...
        jv.setTitle("Relatorio - Ficha Técnica");
        jv.setIconImage(Toolkit.getDefaultToolkit().getImage(FichaTecnicaREPORT.class.getResource("/imagens/real.png")));
    ...
    private void jbEmitirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEmitirActionPerformed
        ...
        if (jCBCategoria.isEnabled() == true) {
            ...
            String src = "/relatorios/fichaTecnicaCategoria.jasper";
            ...
            JasperViewer jv = new JasperViewer(jp, false);
            jv.setTitle("Relatorio - Ficha Técnicas");
            jv.setIconImage(Toolkit.getDefaultToolkit().getImage(FichaTecnicaREPORT.class.getResource("/imagens/real.png")));
            ...
            String src = "/relatorios/fichaTecnicaNome.jasper";
            ...
            if (rbMaior.isSelected() == true) {
                ...
                String src = "/relatorios/fichaTecnicaPrecoMaior.jasper";
                ...
                String src = "/relatorios/fichaTecnicaPrecoMenor.jasper";
                ...
                String src = "/relatorios/fichaTecnicaPrecoIgual.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FichaTecnicaREPORT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JRadioButton rbCusto;
