...
public class MaterialREPORT extends javax.swing.JFrame {
    ...
    public MaterialREPORT() {
        ...
        initComponents();
        setTitle("Relatórios - Materiais");
        setIconImage(Toolkit.getDefaultToolkit().getImage(MaterialREPORT.class.getResource("/imagens/real.png")));
    ...
    private void initComponents() {
        ...
        titulo.setText("Emitir Relatório sobre Materiais");
        ...
        bgPesquisa.add(rbUnidade);
        rbUnidade.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        jLUnidade.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jLUnidade.setText("Unidade:");
        jPanel2.add(jLUnidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 125, 74, 27));

        jLNome.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jLNome.setText("Nome:");
        jPanel2.add(jLNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 74, 27));
        ...
        jCBUnidade.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jPanel2.add(jCBUnidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 127, 190, -1));

        jTNome.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jPanel2.add(jTNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 190, -1));
        ...
        jPanel2.add(jbEmitir, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 210, -1, -1));
    ...
    private void jbEmitirCompletoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEmitirCompletoActionPerformed
        ...
        String src = "/relatorios/materialC.jasper";
        ...
        jv.setTitle("Relatorio - Materiais");
    ...
    private void jbEmitirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEmitirActionPerformed
        ...
        if (jCBCategoria.isEnabled() == true) {
            ...
            String src = "/relatorios/materialCategoria.jasper";
        ...
        } else if (jCBUnidade.isEnabled() == true) {

            Unidade unidade = (Unidade) jCBUnidade.getSelectedItem();

            Connection con = ConnectionFactory.getConnection();

            String src = "/relatorios/materialUnidade.jasper";
            ...
            try {
                ...
                HashMap parametros = new HashMap<>();
                parametros.put("unidade", unidade.getNome());
            ...
            String src = "/relatorios/materialNome.jasper";
            ...
            if (rbMaior.isSelected() == true) {
                ...
                String src = "/relatorios/materialPrecoMaior.jasper";
                ...
                String src = "/relatorios/materialPrecoMenor.jasper";
                ...
                String src = "/relatorios/materialPrecoIgual.jasper";
